...
<div>
    <form wire:submit="register">
        ...
        <div class="mt-4">
            ...
            <x-text-input wire:model.live="email" id="email" class="block mt-1 w-full" type="email" name="email"
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label for="password_confirmation" :value="__('Confime sua senha')" />
